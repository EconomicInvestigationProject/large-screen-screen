	...
	<el-row :gutter="20" style="margin: 0;padding: 0;margin-top: 1vh;">
		<el-col :span="16" style="padding-left: 0;">
			...
			<el-row :gutter="20" style="margin: 0;padding: 0;">
				<el-col :span="12">
					<img src="@/assets/5.webp" style="width: 100%;height:45vh;">
				</el-col>
				<el-col :span="12">
					<img src="@/assets/6.webp" style="width: 100%;height:45vh;">
				</el-col>
			</el-row>
			<el-row :gutter="20" style="margin: 0;padding: 0;margin-top: 1vh;">
				<el-col :span="12">
					<img src="@/assets/7.webp" style="width: 100%;height:45vh;">
				</el-col>
				<el-col :span="12">
					<img src="@/assets/8.webp" style="width: 100%;height:45vh;">
				</el-col>
			</el-row>
		</el-col>
		<el-col :span="8">
			<!-- 实时车位信息 -->
			<chartpanel title="实时车位信息" style="height: 29.5vh;">
			...
			<!-- 小区车位基本信息 -->
			<chartpanel title="车位基本信息" style="height: 29.5vh;margin-top: 1vh;">
				...
				<div class="flex" style="margin-top: 1vh;">
					...
					<div class="flex_item">
						<div class="baseitem text_color_4">
							...
							<div class="label">占用数</div>
						</div>
					</div>
				</div>
			</chartpanel>
			<!-- 进出统计 -->
			<chartpanel title="车辆进出统计" style="height: 29.5vh;margin-top: 1vh;">
...
<script setup>
	...
	const initCharts = () => {
		...
		for (let i = new Date(start.getTime()); i.getTime() < new Date().getTime(); i.setDate(i.getDate() + 1)) {
			devicechartcategory.push(i.format('MM-dd'));
			devicechartvalues.push(utils.random(1000));
		}
		chartutils.initLineChart(devicechartoption, devicechartcategory, devicechartvalues, '#01AAED');
	}
	...
	const startRefreshChart = () => {
		...
		timer = setInterval(function() {
			...
			baseinfo.owner = utils.random(1000),
