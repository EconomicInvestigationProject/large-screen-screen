					  ...
					  >
					        <template #default="{ node, data }">
					          <div class="custom-tree-node flex">
					            <div v-if="data.leaf" style="width:10%;text-align: center;padding-right:0.9375rem">
									<el-icon style="position: relative;top: 0.125rem; font-size: 1.6rem;"><video-camera /></el-icon>
								</div>
					            <div class="flex_item">{{ node.label }}</div>
					            <div style="width:10%;text-align: right;padding-right:0.9375rem">
			...
			<div style="height: 60vh;">
				...
				<chartpanel title="监控摄像头001" style="height: 59vh;">
					<el-row :gutter="20" style="margin: 0;padding: 0;height: 26vh;">
						<el-col :span="8">
							<img src="@/assets/2.webp" style="width: 100%;height:26vh;">
						</el-col>
						<el-col :span="8">
							<img src="@/assets/3.webp" style="width: 100%;height:26vh;">
						</el-col>
						<el-col :span="8">
							<img src="@/assets/4.webp" style="width: 100%;height:26vh;">
						</el-col>
					</el-row>
					<el-row :gutter="20" style="margin: 0;padding: 0;margin-top: 1vh;height: 26vh;">
						<el-col :span="8">
							<img src="@/assets/5.webp" style="width: 100%;height:26vh;">
						</el-col>
						<el-col :span="8">
							<img src="@/assets/6.webp" style="width: 100%;height:26vh;">
						</el-col>
						<el-col :span="8">
							<img src="@/assets/7.webp" style="width: 100%;height:26vh;">
						</el-col>
					</el-row>
				</chartpanel>
			</div>
								...
								<div class="flex" style="margin-top: 2vh;">
									<div class="flex_item ">
										<div class="status_item ">
											<div class="iconpanel">
												<img src="@/assets/img016.png" style="width:50%;">
											</div>
											<div class="">
