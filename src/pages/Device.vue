	...
	<el-row :gutter="20" style="margin: 0px;padding: 0;margin-top: 1vh;">
		<el-col :span="16">
			...
			<div style="position: relative;">
				<div ref="mapchart" id="mapchart" style="height:92.5vh;position: relative"></div>
		...
		<el-col :span="8">
			...
			<chartpanel title="设备分类统计" style="height: 22vh;">
				<v-chart ref="devicechart" style="height:18vh" :option="devicechartoption" />
			</chartpanel>
			<!-- 设备状态统计 -->
			<chartpanel title="设备状态统计" style="height: 22vh;margin-top: 1vh;">
				<v-chart ref="statuschart" style="height:18vh" :option="statuschartoption" />
			</chartpanel>
			<!-- 消防管理 -->
				...
				<div class="statuspanel">
					<div class="flex" style="margin-top: 2vh;">
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><drizzling /></el-icon></div>
						...
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><cherry /></el-icon></div>
						...
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><data-analysis /></el-icon></div>
					...
					<div class="flex" style="margin-top: 1vh;">
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><office-building /></el-icon></div>
						...
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><iphone /></el-icon></div>
						...
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><element-plus /></el-icon></div>
						...
						<div class="flex_item ">
							<div class="status_item flex">
								<div class="iconpanel">
									<div class="icon"><el-icon><basketball /></el-icon></div>
			...
			<chartpanel title="报修管理" style="height: 22vh;margin-top: 1vh;">
				<vue3-seamless-scroll :list="updatedatas" class="scroll">
					<div class="item flex" v-for="(item, index) in updatedatas" :key="index">
...
<script setup>
	...
	let devicechartcategory = reactive(['监控设备', '电梯设备', '门磁设备', '安防设备', '消防设备']);
	...
	const initCharts = () => {
		...
		chartutils.initBarChart(devicechartoption, devicechartcategory, devicechartvalues, '#01AAED');
	...
	const startRefreshChart = () => {
		...
		timer = setInterval(function() {
			...
			statuschartoption.title.forEach((item, index) => {
				item.text = statuschartvalues[index] + '\n\n' + statuschartcategory[index];
			});
			let i = 0;
