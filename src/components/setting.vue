  ...
  <div class="setting_panel">
    <div class="setting_panel_maker" @click="hideSetting">
      <div class="inner_contaner" @click.stop="stopPropagation">
        ...
        <div class="setting_panel_title">系统配置</div>
        <el-form
          ref="settingFormRef"
          :model="settingForm"
          status-icon
        ...
        >
          ...
          >
            ...
            >
              <el-option
                v-for="(optionitem, index1) in item.options"
          ...
          <el-form-item>
            <el-row style="width: 100%">
              ...
              <el-col :span="11">
                <el-button
                  style="width: 100%"
                  @click="defalutForm(settingFormRef)"
                  >恢复默认
                </el-button>
              </el-col>
            </el-row>
...
import "@/assets/style/css/dark_theme.css";
import "@/assets/style/css/default.css";
