<template>
  <el-row
    :gutter="20"
    style="margin-left: 0; margin-right: 0px; margin-top: 1vh"
  >
    <el-col :span="8">
      <!-- 最新公告 -->
        ...
        <div class="flex">
          <div class="flex_item">
            <div
              ref="allchart"
              id="allchart"
              style="height: 26vh; position: relative"
            ></div>
          </div>
    ...
    <el-col :span="16">
      ...
      <chartpanel style="height: 61vh">
        <div class="images">
          <img src="@/assets/images/community/1.webp" class="images" />
          <div class="bg"></div>
...
const startRefreshChart = () => {
  ...
  timer = setInterval(function () {
    ...
    allchartoption.graphic[0].children[0].style.text =
      allchartvalue.value + "%";
